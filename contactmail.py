...
class findMail:
    ...
    def run(self):
        ...
        sendMessage(f"hello the {self.false} is a fake news", "", self.emails, self.social_links).run()


# findMail("https://timesofindia.indiatimes.com/india/centre-defends-in-supreme-court-appointment-of-2-new-ecs-under-new-rules/articleshow/108647091.cms", "im true", "im false").run()
